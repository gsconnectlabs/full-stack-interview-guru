...
System.out.println(user);`,
  ...
  },
  {
    ...
    seoDescription:
      "Java dynamic proxies for interviews: Proxy.newProxyInstance, InvocationHandler, JDK interface proxies vs CGLIB subclassing, and how Spring AOP adds transactions/logging. With runnable examples.",
